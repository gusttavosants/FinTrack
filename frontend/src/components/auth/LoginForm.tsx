...
const LoginForm = () => {
  ...
  return (
    <div className="w-full max-w-md mx-auto px-8">
      <FinTrackLogo size="lg" className="mb-10" />
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 h-12 bg-muted/50 border-input"
            />
          </div>
        </div>
        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              className="pl-12 pr-12 h-12 bg-muted/50 border-input"
            />
            <button
              type="button"
      ...
      <div className="mt-8 flex items-center gap-4">
        <button className="w-12 h-12 rounded-full border border-input bg-background flex items-center justify-center hover:bg-muted transition-colors">
